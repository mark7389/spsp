...
router.route('/classesbyservice/:token/:classId').get(classController.getClassesByService);
...
//update attendeeclass
router.route('/attendee/class_update/:token/:attendeeId/:classId/:date').post(attendeesController.updateAttendeeClass);
